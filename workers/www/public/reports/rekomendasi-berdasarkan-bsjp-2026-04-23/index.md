...
![Perbandingan pertumbuhan modal Model A (Agresif) 100 hari](./pnl_growth_chart_100d.png)
*Gambar: Model A – dari Rp10 juta menjadi Rp32,6 juta, dengan beberapa kali "jurang" penurunan yang dalam.*

![Perbandingan pertumbuhan modal Model B (Terkendali) 100 hari](./pnl_growth_chart_100d_2.png)
*Gambar: Model B – pertumbuhan lebih landai ke Rp21,5 juta, penurunan lebih dangkal.*

> **Catatan:** Dua gambar di atas menunjukkan masing-masing model secara terpisah. Model A (atas) naik lebih curam tapi turun lebih dalam. Model B (bawah) lebih stabil.
...
![Histogram distribusi max drawdown - Model A (Agresif)](./monte_maxdd_hist.png)
*Gambar: Histogram Model A – lebih lebar, ekor sampai -60%, sering mengalami drawdown besar.*

![Histogram distribusi max drawdown - Model B (Terkendali)](./monte_maxdd_hist_2.png)
*Gambar: Histogram Model B – lebih sempit, terpusat di -25%, ekor pendek.*
...
![Perbandingan performa 20 hari terakhir - Model A](./pnl_growth_chart_last20d.png)
*Gambar: Rolling 20-day performance Model A – fluktuasi besar.*

![Perbandingan performa 20 hari terakhir - Model B](./pnl_growth_chart_last20d_2.png)
*Gambar: Rolling 20-day performance Model B – lebih stabil, penurunan dangkal.*
...
![Kurva CDF hasil Monte Carlo - Model A](./monte_return_cdf.png)
*Gambar: CDF Model A – kurva di kanan (untung besar) tapi ekor kiri (rugi) masih ada.*

![Kurva CDF hasil Monte Carlo - Model B](./monte_return_cdf_2.png)
*Gambar: CDF Model B – lebih rapat, probabilitas rugi sangat kecil.*
...
![Fan chart simulasi ekuitas - Model A](./monte_equity_fan.png)
*Gambar: Fan chart Model A – sebaran lintasan sangat lebar.*

![Fan chart simulasi ekuitas - Model B](./monte_equity_fan_2.png)
*Gambar: Fan chart Model B – sebaran lebih sempit, lebih dapat diprediksi.*
...
## Lampiran Visual Tambahan

### A. Perbandingan Kelly vs Baseline (Target Cumulative Return)

![Kelly comparison cumulative return](./kelly_compare_cumret.png)

### B. Perbandingan Kelly vs Baseline (Close10 Objective)

![Kelly comparison close10 objective cumulative return](./kelly_compare_close10_obj_cumret.png)